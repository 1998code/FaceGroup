...
ยินดีรับการมีส่วนร่วม! หากคุณต้องการช่วยปรับปรุงเครื่องมือนี้ โปรด:
1. Fork พื้นเก็บข้อมูลนี้
2. สร้างสาขาใหม่สำหรับฟีเจอร์หรือการแก้ไขบักของคุณ
3. ส่ง pull request พร้อมคำอธิบายที่ชัดเจนเกี่ยวกับการเปลี่ยนแปลงของคุณ
...
โปรเจกต์นี้ได้รับสัญญาอนุญาตภายใต้ MIT License - ดูรายละเอียดที่ไฟล์ [LICENSE](../LICENSE)